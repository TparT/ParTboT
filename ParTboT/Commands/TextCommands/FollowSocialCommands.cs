...
//                SearchChannelsResponse Search = await Services.TwitchAPI.Helix.Search.SearchChannelsAsync(TwitchChannelToFollow).ConfigureAwait(false);
//                Channel FirstMatch = Search.Channels[0];

//                DiscordEmbedBuilder Embed = new DiscordEmbedBuilder()
//                    .WithTitle($"Found {Search.Channels.Length} results for {TwitchChannelToFollow}")
